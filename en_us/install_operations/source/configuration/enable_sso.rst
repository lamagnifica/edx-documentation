...
Ability to specify default 3rd party auth via QueryString parameter: https://github.com/edx/edx-platform/pull/8591 

Secondary providers: https://github.com/edx/edx-platform/pull/8603

Skip registration form: https://github.com/edx/edx-platform/pull/8603

Skip email verification: https://github.com/edx/edx-platform/pull/8603 

Configuring icons with Python social auth: https://github.com/edx/edx-platform/pull/8599 (leave as stub/outline for edX folks)


*****************************************************************
Case Study: Setting Up SSO with Azure Active Directory
*****************************************************************

Configuring Azure – how to set-up AAD (with a free Azure account)

Configuring SSO in edX – how to configure edX to use AAD for SSO
